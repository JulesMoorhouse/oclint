...
class url:
    ...
    clang_prebuilt_binary_for_macos_arm64 = 'https://github.com/julesmoorhouse/llvm-builder/releases/download/llvm-14.0.0/llvm-14.0.0-arm64-apple-darwin.tar.xz'
